...
Протестируй мобильное приложение: [yandex.samokat.apk](https://code.s3.yandex.net/qa/files/scooter-v2.0.apk)https://code.s3.yandex.net/qa/files/scooter-v2.0.apk
